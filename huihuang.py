    ...
    while 1:
        try:
            ...
            for key,expect in enumerate(datas):
                ...
                periodDict = {'shks': 41, 'shsyxw': 45,'fjks':42,'fjsyxw':45,'hubks':39,'hbsyxw':40,'jxks':42,'jxsyxw':42,'zjsyxw':42,'sxsyxw':44}
                openTimeDict = {'shks': '08:38:00','shsyxw': '09:00:00','fjks':'08:30:00','fjsyxw':'08:10:00','sxsyxw':'08:30:00',
                                'hubks':'09:00:00','hbsyxw':'08:35:00','jxks':'08:15:00','jxsyxw':'09:10:00','zjsyxw':'08:30:00'}

                areaDict = {'shsyxw': 'shanghai', 'fjsyxw': 'fujian', 'hbsyxw': 'hubei', 'jxsyxw': 'jiangxi','zjsyxw': 'zhejiang','sxsyxw':'shanxi'}
                codeDict = {'shks': 'shk3', 'shsyxw': 'sh11x5', 'fjks': 'fjk3', 'fjsyxw': 'fj11x5', 'hubks': 'hubk3',
                            'hbsyxw': 'hub11x5', 'jxks': 'jxk3', 'jxsyxw': 'jx11x5', 'zjsyxw': 'zj11x5','sxsyxw':'sx11x5'}
                ...
                if variety in periodDict and int(expect[-2:]) < periodDict[variety]:
                    ...
                    secondTimeDict = {'fjks': '08:50:00', 'shks': '08:58:00', 'jxks': '08:35:00','hubks': '09:20:00','shsyxw': '09:20:00',
                                      'hbsyxw': '08:55:00', 'zjsyxw': '08:50:00', 'fjsyxw': '08:30:00','jxsyxw': '09:30:00','sxsyxw': '08:50:00'}
...
def spliceExpect(variety, expect, nextExpect):
    ...
    if 'syxw' in variety and len(expect) == 8:
        if variety in ['fjsyxw', 'hbsyxw', 'zjsyxw','sxsyxw']:
            expect = '20' + expect
...
if __name__ == '__main__':
    # create_database()
    varietys = ['shks', 'shsyxw','fjks','fjsyxw','hubks','hbsyxw','jxks','jxsyxw','zjsyxw','sxsyxw']
    # varietys = [ 'sxsyxw']
